    ...
    <div class="logo">
        <RouterLink to="/">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                xmlns:svgjs="http://svgjs.dev/svgjs" width="175" height="48" viewBox="0 0 175 48">
                <g transform="matrix(1,0,0,1,-1.2121212121212466,0.9787838168253415)"><svg viewBox="0 0 396 111"
                        data-background-color="#ffffff" preserveAspectRatio="xMidYMid meet" height="48" width="175"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="tight-bounds" transform="matrix(1,0,0,1,0.2400000000000091,-0.1940089351207348)"><svg
                                viewBox="0 0 395.52 111.38801787024146" height="111.38801787024146" width="395.52">
                                <g><svg viewBox="0 0 651.9566349808048 183.60678930993217" height="111.38801787024146"
                                        width="395.52">
                                        <g>
                                            <rect width="5.064998417424747" height="183.60678930993217"
                                                x="238.1124784025823" y="0" fill="#0074d9" opacity="1" stroke-width="0"
                                                            ...
                                                            <g transform="matrix(1,0,0,1,0,0)"><svg width="395.52"
                                                                    ...
                                                                    <g class="wordmark-text-0"
                                                                        ...
                                                                        <path xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            opacity="1"></path>
                                                                        <path xmlns="http://www.w3.org/2000/svg"
                                                                            d="M44.2 38.6h-10.95v-12.4c0-1.533 0.06-3.11 0.18-4.73 0.113-1.613 0.237-2.97 0.37-4.07 0.133-1.1 0.217-1.8 0.25-2.1v0h-0.2l-6.35 23.3h-8.65l-6.4-23.25h-0.2c0.033 0.3 0.127 0.99 0.28 2.07 0.147 1.087 0.287 2.437 0.42 4.05 0.133 1.62 0.2 3.197 0.2 4.73v0 12.4h-10.15v-34.4h15.6l5.2 19.85h0.2l5.15-19.85h15.05zM72.25 25.25v13.35h-11.05v-13.35l-13.65-21.05h12.7l6.6 11.45h0.2l6.6-11.45h12.05z"
                                                                            fill="#010c80" fill-rule="nonzero"
                                                                            stroke="none" stroke-width="1"
                                                                            stroke-linecap="butt"
                                                                            stroke-linejoin="miter"
                                                                            stroke-miterlimit="10" stroke-dasharray=""
